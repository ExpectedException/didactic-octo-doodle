...
namespace Steam_Desktop_Authenticator
{
    public partial class MainForm : Form
    {
        ...
        private void btnSteamLogin_Click(object sender, EventArgs e)
        {
            ...
            var _mailImap = File.Exists("imap.txt") ? File.ReadAllText("imap.txt") : "imap.rambler.ru";
            ...
            foreach (var accountData in accounts)
            {
                ...
                if (array.Length > 0)
                {
                    ...
                    LoginForm loginForm1 = new LoginForm(LoginForm.LoginType.Initial, null, _mailImap, array[2], array[3], array[0], array[1]);
                    //this.loadAccountsList();
                    
                }
                
                    //new LoginForm(array[2], array[3], array[0], array[1]).;
